...
build-dir: $(BUILD_DIR)/src tflite-micro-src $(BUILD_DIR_EXTRA_DEP) 
	...
	$(COPY) $(DONUT_SRC_DIR)/layer1_data.*     $(BUILD_DIR)/src
	$(COPY) $(DONUT_SRC_DIR)/layer2_data.*     $(BUILD_DIR)/src
	$(COPY) $(DONUT_SRC_DIR)/layer3_data.*     $(BUILD_DIR)/src
	$(COPY) $(DONUT_SRC_DIR)/test_data.*     $(BUILD_DIR)/src
